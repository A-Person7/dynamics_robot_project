...
\begin{document}
	...
	\section*{Solution Methods}
       ...
       Initially, we tried a number of methods to find a function for $y$. We tried assuming a constant snap, and integrating backwards, using initial conditions to solve variables. 
    \begin{equation*}
        \dddot{y} = A
    \end{equation*}
