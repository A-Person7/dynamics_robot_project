...
\begin{document}
	...
	\end{equation}
	We can then find the needed derivatives of $y\left(t\right)$
	\begin{equation}
    ...
    We can then add in our function of $y\left(t\right)$ and get the functions for the parameters of the actuators. The value of $r$ tells us the length of the linear actuator in the arm, and the value of $\theta$ tells us the angle of the actuator at the base of the arm (with respect to the horizontal axis). 
	\begin{equation}
	r = \sqrt{0.25+\left( 160.4 \cdot t^4 - 105.78 \cdot t^3 + 14.71 \cdot t^2 + 0.4\right)^2}
	\end{equation}
	\begin{equation}
	r = \sqrt{25728.16 \cdot t^8 - 33934.224 \cdot t^7 + 15908.3764 \cdot t^6 - 3112.0476 \cdot t^5 + 344.7041 \cdot t^4 - 84.624\cdot t^3 + 11.768 \cdot t^2 + 0.41}
	\end{equation}
	\begin{equation}
	...
	%% TODO ADD GRAPHS OF THESE FUNCTIONS
